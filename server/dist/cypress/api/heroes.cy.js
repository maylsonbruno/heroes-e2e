    ...
    describe('requires auth', () => {
        ...
        it('can add hero', () => {
            ...
            cy.get('@response')
                .its('body')
                .then((newHero) => {
                cy.wrap(newHero).should('deep.include', Object.assign(Object.assign({}, hero), { powers: [
                        {
                            id: 1,
                            name: 'Flying',
                        },
        ...
        it('should update hero', () => {
            ...
            cy.get('@newHero').then((newHero) => {
                ...
                cy.get('@response')
                    .its('body')
                    .should('deep.include', Object.assign(Object.assign({}, newHero), { powers: [
                        {
                            id: 1,
                            name: 'Flying',
                        },
        ...
        it('can upload avatar image', () => {
            ...
            cy.get('@newHero').then((newHero) => {
                cy.fixture('avatar.png', 'binary').then((binaryString) => {
                    const blob = Cypress.Blob.binaryStringToBlob(binaryString, 'image/png');
...
//# sourceMappingURL=heroes.cy.js.map